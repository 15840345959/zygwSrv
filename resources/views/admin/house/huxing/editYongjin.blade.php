    ...
    <div class="page-container">
        <form class="form form-horizontal" id="form-edit">
            ...
            <div class="row cl">
                ...
                <div class="formControls col-xs-8 col-sm-9">
                    <input id="house_title" name="house_title" type="text" class="input-text" style="width:200px"
                           value="{{ isset($data->house->title) ? $data->house->title : '' }}" placeholder="请输入楼盘名称"
                           disabled="">
                </div>
            </div>
            <div class="row cl">
                ...
                <div class="formControls col-xs-8 col-sm-9">
                    <input id="name" name="name" type="text" class="input-text" style="width: 200px;"
                           value="{{ isset($data->name) ? $data->name : '' }}" placeholder="请输入产品名称" disabled="">
                </div>
            </div>
            <div class="row cl">
                ...
                <div class="formControls col-xs-8 col-sm-9">
                    <span class="select-box" style="width: 200px;">
                        <select id="yongjin_type" name="yongjin_type" class="select">
            ...
            <div class="row cl">
                <div class="col-xs-8 col-sm-9 col-xs-offset-4 col-sm-offset-2">
                    <input class="btn btn-primary radius" type="submit" value="保存佣金设置">
        ...
        $(function () {
            ...
            $("#form-edit").validate({
                ...
                submitHandler: function (form) {
                    ...
                    $(form).ajaxSubmit({
                        type: 'POST',
                        url: "{{ URL::asset('admin/house/huxing/editYongjin')}}",
