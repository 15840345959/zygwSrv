            ...
            <div class="row cl">
                ...
                <div class="formControls col-xs-8 col-sm-9">
                    <input id="house_title" name="house_title" type="text" class="input-text" disabled="disabled"
                           value="{{ isset($house->title) ? $house->title : '' }}" placeholder="请输入楼盘名称">
                </div>
            </div>
            <div class="row cl">
                <label class="form-label col-xs-4 col-sm-2"><span class="c-red">*</span>手机号：</label>
                <div class="formControls col-xs-8 col-sm-9">
                    <textarea id="phonenums" name="phonenums" type="text" class="input-text" style="height: 300px;"
                              value="" placeholder="请输入手机号"></textarea>
                </div>
            </div>
            <div class="row cl" style="padding-top: 20px;">
                <div class="col-xs-8 col-sm-9 col-xs-offset-4 col-sm-offset-2">
                    <input class="btn btn-primary radius" onclick="clickFormateText();" value="整理格式（上传前请先整理格式）">
...
@section('script')
    ...
    <script type="text/javascript">
        ...
        //点击整理格式
        function clickFormateText() {
            var phonenums = $("#phonenums").val();
            $("#phonenums").val(formateText(phonenums).trim());
        }
        ...
        $(function () {
            ...
            $("#form-edit").validate({
                ...
                submitHandler: function (form) {
                    ...
                    $(form).ajaxSubmit({
                        type: 'POST',
                        url: "{{ URL::asset('/admin/house/houseClient/edit')}}",
