    ...
    <div class="page-container">
        <form class="form form-horizontal" id="form-edit">
            ...
            <div class="row cl hidden">
                ...
                <div class="formControls col-xs-8 col-sm-9">
                    <input id="id" name="id" type="text" class="input-text"
                           value="{{ isset($data->id) ? $data->id : '' }}" placeholder="户型样式id">
                </div>
            </div>
            <div class="row cl hidden">
                <label class="form-label col-xs-4 col-sm-2"><span class="c-red">*</span>产品id：</label>
                <div class="formControls col-xs-8 col-sm-9">
                    <input id="huxing_id" name="huxing_id" type="text" class="input-text"
                           value="{{ isset($huxing->id) ? $huxing->id : '' }}" placeholder="产品id">
                </div>
            </div>
            <div class="row cl">
                <label class="form-label col-xs-4 col-sm-2"><span class="c-red">*</span>产品：</label>
                <div class="formControls col-xs-8 col-sm-9">
                    <input id="id" name="id" type="text" class="input-text" disabled
                           value="{{ isset($huxing->name) ? $huxing->name : '' }}" placeholder="产品名称">
                </div>
            </div>
            <div class="row cl">
                ...
                <div class="formControls col-xs-8 col-sm-9">
                    <input id="name" name="name" type="text" class="input-text"
                           value="{{ isset($data->name) ? $data->name : '' }}" placeholder="请输入户型样式名称">
                </div>
            </div>
            ...
            <div class="row cl">
                ...
                <div class="formControls col-xs-8 col-sm-9">
                    <input id="size" name="size" type="number" class="input-text" style="width: 120px;"
                           value="{{ isset($data->size) ? $data->size : '' }}" placeholder="">
                    <span>m²</span>
                </div>
            </div>
            <div class="row cl">
            ...
            <div class="row cl">
                ...
                <div class="formControls col-xs-8 col-sm-9">
                    <input id="orientation" name="orientation" type="text" class="input-text"
                           value="{{ isset($data->orientation) ? $data->orientation : '' }}" placeholder="请输入户型样式朝向">
                </div>
            </div>
            <div class="row cl">
                ...
                <div class="formControls col-xs-8 col-sm-9">
                    <input id="reason" name="reason" type="text" class="input-text"
                           value="{{ isset($data->reason) ? $data->reason : '' }}" placeholder="请输入推荐理由">
                </div>
            </div>
            <div class="row cl item">
            ...
            <div class="row cl" style="padding-top: 20px;">
                <div class="col-xs-8 col-sm-9 col-xs-offset-4 col-sm-offset-2">
                    <input class="btn btn-primary radius" type="submit" value="保存户型样式">
        ...
        $(function () {
            ...
            $("#form-edit").validate({
                ...
                submitHandler: function (form) {
                    ...
                    $(form).ajaxSubmit({
                        type: 'POST',
                        url: "{{ URL::asset('/admin/house/huxingStyle/edit')}}",
