    ...
    <div class="page-container">
        <form class="form form-horizontal" id="form-edit">
            ...
            <div class="row cl hidden">
                ...
                <div class="formControls col-xs-8 col-sm-9">
                    <input id="id" name="id" type="text" class="input-text"
                           value="{{ isset($data->id) ? $data->id : '' }}" placeholder="联系人id">
                </div>
            </div>
            <div class="row cl">
                ...
                <div class="formControls col-xs-8 col-sm-9">
                    <input id="name" name="name" type="text" class="input-text"
                           value="{{ isset($data->name) ? $data->name : '' }}" placeholder="请输入联系人姓名">
                </div>
            </div>
            <div class="row cl">
                ...
                <div class="formControls col-xs-8 col-sm-9">
                    <input id="phonenum" name="phonenum" type="text" class="input-text"
                           value="{{ isset($data->phonenum) ? $data->phonenum : '' }}" placeholder="请输入联系人电话">
                </div>
            </div>
            <div class="row cl">
            ...
            <div class="row cl">
                ...
                <div class="formControls col-xs-8 col-sm-9">
                    <input id="wx_code" name="wx_code" type="text" class="input-text"
                           value="{{ isset($data->wx_code) ? $data->wx_code : '' }}" placeholder="请输入联系人微信号">
                </div>
            </div>
            <div class="row cl">
                <label class="form-label col-xs-4 col-sm-2"><span class="c-red">*</span>职位：</label>
                <div class="formControls col-xs-8 col-sm-9">
                    <input id="position" name="position" type="text" class="input-text"
                           value="{{ isset($data->position) ? $data->position : '' }}" placeholder="请输入联系人职位">
                </div>
            </div>
            <div class="row cl">
                <label class="form-label col-xs-4 col-sm-2"><span class="c-red">*</span>职责：</label>
                <div class="formControls col-xs-8 col-sm-9">
                    <input id="duty" name="duty" type="text" class="input-text"
                           value="{{ isset($data->duty) ? $data->duty : '' }}" placeholder="请输入联系人职责">
                </div>
            </div>
            <div class="row cl" style="padding-top: 20px;">
                <div class="col-xs-8 col-sm-9 col-xs-offset-4 col-sm-offset-2">
                    <input class="btn btn-primary radius" type="submit" value="保存联系人">
        ...
        $(function () {
            ...
            $("#form-edit").validate({
                ...
                submitHandler: function (form) {
                    ...
                    $(form).ajaxSubmit({
                        type: 'POST',
                        url: "{{ URL::asset('/admin/house/houseContact/edit')}}",
