...
@section('content')
    ...
    <nav class="breadcrumb"><i class="Hui-iconfont">&#xe67f;</i> 首页 <span class="c-gray en">&gt;</span> 中介人员管理 <span
                class="c-gray en">&gt;</span> 中介人员列表 <a class="btn btn-success radius r btn-refresh"
                                                        style="line-height:1.6em;margin-top:3px"
                                                        href="javascript:location.replace('{{URL::asset('/admin/user/userZJ/index')}}');"
                                                        title="刷新"
                                                        onclick="location.replace('{{URL::asset('/admin/user/userZJ/index')}}');"><i
                    class="Hui-iconfont">&#xe68f;</i></a></nav>
    <div class="page-container">
        <div class="text-c">
            <form id="search_form" action="{{URL::asset('/admin/user/userZJ/index')}}?page={{$datas->currentPage()}}"
        ...
        <div class="mt-20">
            <table class="table table-border table-bordered table-bg table-sort">
                <thead>
                <tr>
                    <th scope="col" colspan="100">中介人员列表</th>
                </tr>
                <tr class="text-c">
