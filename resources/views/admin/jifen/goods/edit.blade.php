    ...
    <div class="page-container">
        <form class="form form-horizontal" id="form-edit">
            ...
            <div class="row cl">
                ...
                <div class="formControls col-xs-8 col-sm-9">
                    <input id="seq" name="seq" type="number" class="input-text" style="width: 150px;"
            ...
            <div class="row cl">
                ...
                <div class="formControls col-xs-8 col-sm-9">
                    <input id="jifen" name="jifen" type="number" class="input-text" style="width: 150px;"
                           value="{{ isset($data->jifen) ? $data->jifen : '0' }}" placeholder="请输入积分值">
                </div>
            </div>
            <div class="row cl">
                <label class="form-label col-xs-4 col-sm-2"><span class="c-red"></span>商品描述：</label>
                <div class="formControls col-xs-8 col-sm-9">
                    <textarea id="desc" name="desc" type="text" class="input-text" style="width: 100%;height: 200px;"
            ...
            <div class="row cl" style="padding-top: 20px;">
                <div class="col-xs-8 col-sm-9 col-xs-offset-4 col-sm-offset-2">
                    <input class="btn btn-primary radius" type="submit" value="保存商品">
        ...
        $(function () {
            ...
            $("#form-edit").validate({
                ...
                submitHandler: function (form) {
                    ...
                    $(form).ajaxSubmit({
                        type: 'POST',
                        url: "{{ URL::asset('/admin/jifen/goods/edit')}}",
