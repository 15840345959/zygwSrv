    ...
    <div class="page-container">
        <form class="form form-horizontal" id="form-edit">
            ...
            <div class="row cl">
                ...
                <div class="formControls col-xs-8 col-sm-9">
                    <input id="name" name="name" type="text" class="input-text" style="width:350px"
            ...
            <div class="row cl">
                ...
                <div class="formControls col-xs-8 col-sm-9">
                    <span class="c-999">新建管理员的默认密码为Aa123456</span>
                </div>
            </div>
            <div class="row cl">
                <label class="form-label col-xs-4 col-sm-2"><span class="c-red">*</span>联系电话：</label>
                <div class="formControls col-xs-8 col-sm-9">
                    <input id="phonenum" name="phonenum" type="text" class="input-text" style="width:350px"
                           value="{{ isset($data->phonenum) ? $data->phonenum : '' }}" {{$data->id?'disabled':''}}>
                </div>
            </div>
            <div class="row cl">
                <label class="form-label col-xs-4 col-sm-2">头像：</label>
                <div class="formControls col-xs-8 col-sm-9">
                    <input id="avatar" name="avatar" type="text" class="input-text" style="width:350px"
            ...
            <div class="row cl">
                ...
                <div class="formControls col-xs-8 col-sm-9">
                    ...
                    <select id="type" name="type" class="select">
                        @foreach(\App\Components\Value::ADMIN_ROLE_VAL as $key=>$value)
