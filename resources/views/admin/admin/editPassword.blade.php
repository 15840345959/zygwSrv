        ...
        <form class="form form-horizontal" id="form-edit">
            ...
            <div class="row cl">
                ...
                <div class="formControls col-xs-8 col-sm-9">
                    <input id="password" name="password" type="password" class="input-text" style="width:350px"
                           value="">
                </div>
            </div>
            <div class="row cl">
            ...
            <div class="row cl">
                ...
                <div class="formControls col-xs-8 col-sm-9">
                    <span class="c-999">密码必须6位以上，包含字母和数字</span>
                </div>
            </div>

            <div class="row cl">
                <div class="col-xs-8 col-sm-9 col-xs-offset-4 col-sm-offset-2">
                    <input class="btn btn-primary radius" type="submit" value="保存密码">
        ...
        $(function () {
            ...
            $("#form-edit").validate({
                ...
                submitHandler: function (form) {
                    ...
                    $("#confirm_password").val(hex_md5(password));

                    $(form).ajaxSubmit({
                        type: 'POST',
                        url: "{{ URL::asset('admin/admin/editPassword')}}",
