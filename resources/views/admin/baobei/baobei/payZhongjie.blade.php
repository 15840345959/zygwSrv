    ...
    <div class="page-container">
        <form class="form form-horizontal" id="form-edit">
            ...
            <div class="row cl">
                ...
                <div class="formControls col-xs-8 col-sm-9">
                    <input id="trade_no" name="trade_no" type="text" class="input-text" disabled
            ...
            <div class="row cl">
                <label class="form-label col-xs-4 col-sm-2"><span class="c-red">*</span>结算凭证：</label>
                <div class="formControls col-xs-8 col-sm-9">
                    <input id="pay_zhongjie_attach" name="pay_zhongjie_attach" type="text" class="input-text"
                           value="{{ isset($data->pay_zhongjie_attach) ? $data->pay_zhongjie_attach : '' }}"
                           placeholder="请输入结算凭证">
                </div>
            </div>
            <div class="row cl">
                ...
                <div class="formControls col-xs-8 col-sm-9">
                    <div id="container">
                        <img id="pickfiles"
                             src="{{ $data->pay_zhongjie_attach ? $data->pay_zhongjie_attach.'?imageView2/1/w/200/h/100/interlace/1/q/75|imageslim' : URL::asset('/img/upload.png')}}"
                             style="width: 350px;">
                    </div>
            ...
            <div class="row cl" style="padding-top: 20px;">
                <div class="col-xs-8 col-sm-9 col-xs-offset-4 col-sm-offset-2">
                    <input class="btn btn-primary radius" type="submit" value="进行中介结算">
        ...
        $(function () {
            ...
            $("#form-edit").validate({
                ...
                submitHandler: function (form) {
                    ...
                    $(form).ajaxSubmit({
                        type: 'POST',
                        url: "{{ URL::asset('/admin/baobei/baobei/payZhongjie')}}",
